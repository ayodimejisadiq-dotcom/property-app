              ...
              {deal.yield_score != null && deal.yield_score >= 60 ? (
                <ul className="text-sm text-body space-y-1.5">
                  <li className="flex gap-2">
                    ...
                    Gross yield of {formatPercent(deal.gross_yield_bps)}{" "}
                    sits at or above the UK BTL benchmark.
                  </li>
                </ul>
              ) : (
                <p className="text-sm text-muted italic">
                  AI report ships in Phase 4. For now, refer to the factor
                  scores and financials above.
                </p>
              )}
            </div>
            <div>
              ...
              <ul className="text-sm text-body space-y-1.5">
                <li className="flex gap-2">
                  ...
                  Five factors couldn&apos;t be scored without Phase 3 data —
                  treat the composite as provisional.
                </li>
                {(deal.monthly_cashflow ?? 0) < 0 && (
                  <li className="flex gap-2">
                    <ShieldAlert className="h-4 w-4 text-[var(--color-warning)] mt-0.5 shrink-0" />
                    Monthly cashflow is negative on these assumptions; the deal
                    relies on capital growth alone.
                  </li>
                )}
              </ul>
            </div>
